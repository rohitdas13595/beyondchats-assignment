...
export function TestView({ chatbot }: { chatbot: any }) {
            ...
            <div className="absolute bottom-4 right-4  ">
              {extended ? (
                <div className="rounded-xl overflow-hidden border border-crust bg-white shadow-2xl">
                  ...
                  >
                    <div className="flex-col flex p-2 w-full h-full justify-center items-center">
                      <button className="flex justify-center items-center p-1 rounded-full bg-mantle hover:bg-crust py-2 px-4">
                        Share Feedback
                      </button>
                    </div>
                  </div>
